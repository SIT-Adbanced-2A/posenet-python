...
def _process_input(res, source_img, scale_factor=1.0, output_stride=16):
    ...
    return res, input_img, source_img, scale
...
def read_cap(cap, scale_factor=1.0, output_stride=16):
    ...
    return _process_input(res, img, scale_factor, output_stride)
